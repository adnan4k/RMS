...
function Navbar() {
  ...
  return (
      <nav className="bg-white dark:bg-gray-900 fixed w-full z-[10000] top-0 start-0 border-b border-gray-200 dark:border-gray-600">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="mx-5 flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            :
            (status === 'success' && data)?  <ShowProfile {...data}/>
            :
            <><Link to='/login'>
            <button
              type="button"
