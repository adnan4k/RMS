...
export const AddBankAccounts = () => {
    ...
    return (
        <div className="grid grid-cols-2 gap-4 h-[70%] w-[60%] mx-auto">
            <div className="flex flex-col">
                <img className="h-auto w-full rounded-lg rounded-b-none h-full dark:bg-white" src="images/CBE.webp" alt="" />
                {CBE.map((val, idx) =>
                    <div className="relative">
                        <input key={idx} type="text" aria-describedby="helper-text-explanation" value={val} onChange={(e)=>handleChange(e.target.value, idx, CBE, setCBE)} className="bg-gray-50 border border-gray-300 outline-none text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 peer" placeholder="Account Number" />
            ...
            <div className="flex flex-col">
                <img className="h-auto w-full rounded-lg rounded-b-none h-full dark:bg-white" src="images/Bank_of_Abyssinia.png" alt="" />
                {BOA.map((val, idx)=>
                    <div className="relative">
                        <input key={idx} type="text" aria-describedby="helper-text-explanation" value={val} onChange={(e)=>handleChange(e, BOA, setBOA)} className="bg-gray-50 border border-gray-300 outline-none text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Account Number" />
            ...
            <div className="flex flex-col">
                <img className="h-auto w-full rounded-lg rounded-b-none h-full dark:bg-white" src="images/download.png" alt="" />
                {awash.map((val, idx)=>
                <div className="relative">
                    <input key={idx} type="text" aria-describedby="helper-text-explanation" value={val} onChange={(e)=>handleChange(e, awash, setAwash)} className="bg-gray-50 border border-gray-300 outline-none text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Account Number" />
            ...
            <div className="flex flex-col">
                <img className="h-auto w-full rounded-lg rounded-b-none h-full dark:bg-white" src="images/hijra.png" alt="" />
                {hijra.map((val, idx)=>
                    <div className="relative">
                        <input key={idx} type="text" aria-describedby="helper-text-explanation" value={val} onChange={(e)=>handleChange(e, hijra, setHijra)} className="bg-gray-50 border border-gray-300 outline-none text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Account Number" />
