    ...
    return (
            <div className="grid grid-cols-2 gap-4 max-w-[595px]">
                ...
                <div className="flex flex-col">
                    ...
                    {BOA.map((val, idx)=>
                        <div key={idx} className="relative">
                            <input type="text" aria-describedby="helper-text-explanation" value={val} onChange={(e)=>handleChange(e.target.value, idx, BOA, setBOA)} className="bg-gray-50 border border-gray-300 outline-none text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 peer" placeholder="Account Number" />
                ...
                <div className="flex flex-col">
                    ...
                    {awash.map((val, idx)=>
                    <div key={idx} className="relative">
                        <input type="text" aria-describedby="helper-text-explanation" value={val} onChange={(e)=>handleChange(e.target.value, idx, awash, setAwash)} className="bg-gray-50 border border-gray-300 outline-none text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 peer" placeholder="Account Number" />
                ...
                <div className="flex flex-col">
                    ...
                    {hijra.map((val, idx)=>
                        <div key={idx} className="relative">
                            <input type="text" aria-describedby="helper-text-explanation" value={val} onChange={(e)=>handleChange(e.target.value, idx, hijra, setHijra)} className="bg-gray-50 border border-gray-300 outline-none text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 peer" placeholder="Account Number" />
