        ...
        <div className={"min-h-64 relative min-w-64 max-w-64 my-3 flex flex-col p-2 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 overflow-hidden transition duration-300 " + (collapse ? "max-h-10 min-h-10" : "")}>
            ...
            <div className="flex">
                <div class="relative border">
                    <input type="number" id="small_outlined" onChange={(e) => setMinprice(e.target.value)} value={minprice} class="block px-2.5 pb-1.5 pt-3 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                ...
                <div class="relative border">
                    <input type="number" id="small_outlined" onChange={(e) => setMaxprice(e.target.value)} value={maxprice} class="block px-2.5 pb-1.5 pt-3 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
            ...
            <div className='p-1 flex-1 overflow-y-scroll'>
                {
                    DEFAULT_PRICES.map((prices, index) => 
                        <div key={index} class="flex items-center m-1.5">
                            <input checked={searchParams.get("minprice") == prices.min && searchParams.get("maxprice") == prices.max} onChange={(e) => onChange(e, prices)} id={""+index} type="radio" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600 "/>
                            <label for={''+index} class="ms-2 font-medium text-gray-900 dark:text-gray-300">{
