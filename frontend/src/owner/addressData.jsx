...
function AddressData({ addressData, setAddressData }) {
    ...
    return (
        <div className='flex flex-col justify-center items-center'>
            ...
            <MapComponent markerPosition={[addressData.latitude, addressData.longitude]} setMarkerPosition={([lat, lng]) => setAddressData({...addressData, 'longitude':lng, 'latitude': lat})}/>
        </div>
    )
}
