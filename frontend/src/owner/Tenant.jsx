        ...
        <div className="min-w-[23rem] w-[70%] bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 self-center mx-auto px-5 text-center py-5">
            {status === 'error' && 
                <section class="bg-white dark:bg-gray-900">
                    <div class="py-8 px-4 mx-auto text-center">
                        <h1 class="mb-4 text-xl font-bold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">An error occured</h1>
                    </div>
                </section>
            }
            {data&&
            <div className="flex flex-col items-center py-10">
                ...
                <Modal open={!hide && contractStatus === 'success'} onClose={()=>setHide(true)}>
                    <div className="w-[70%] h-[70%] p-8 bg-gray-800 dark:border-gray-200">
