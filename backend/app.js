...
app.use('/contracts', verifyToken('admin', 'tenant', 'owner'), express.static('contracts'))
app.use('/nationalids', verifyToken('admin', 'tenant', 'owner'), express.static('nationalids'))
